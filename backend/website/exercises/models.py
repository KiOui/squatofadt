...
class Exercise(models.Model):
    ...
    min_range_amount = models.IntegerField(
        default=2,
        help_text="Minimum of the range where a random amount for this " "exercise will be picked out of",
        blank=False,
        null=False,
    )
    max_range_amount = models.IntegerField(
        default=5,
        help_text="Maximum of the range where a random amount for this " "exercise will be picked out of",
        blank=False,
        null=False,
    )
...
class Player(models.Model):
    ...
    multiplier = models.IntegerField(
        default=1, help_text="How many chances per roll a player gets for losing", blank=False, null=False
    )
